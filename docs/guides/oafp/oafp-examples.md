...
| Mac | Safari | [54](#54) | Get a list of all Mac OS Safari bookmarks into a CSV file. |
| OpenAF | Channels | [55](#55) | Copy the json result of a command into an etcd database using OpenAF&#x27;s channels |
| OpenAF | Channels | [56](#56) | Getting all data stored in an etcd database using OpenAF&#x27;s channels |
| OpenAF | Channels | [57](#57) | Perform a query to a metric &amp; label, with a start and end time, to a Prometheus server using OpenAF&#x27;s channels |
| OpenAF | Channels | [58](#58) | Retrieve all keys stores in a H2 MVStore file using OpenAF&#x27;s channels |
| OpenAF | Channels | [59](#59) | Store and retrieve data from a Redis database |
| OpenAF | Channels | [60](#60) | Store and retrieve data from a RocksDB database |
| OpenAF | Channels | [61](#61) | Store the json results of a command into a H2 MVStore file using OpenAF&#x27;s channels |
| OpenAF | Network | [62](#62) | List all network addresses returned from the current DNS server for a hostname using OpenAF |
| OpenAF | OS | [63](#63) | Current OS information visible to OpenAF |
| OpenAF | TLS | [64](#64) | List the TLS certificates of a target host with a sorted alternative names using OpenAF |
| OpenAF | oPacks | [65](#65) | Listing all currently accessible OpenAF&#x27;s oPacks |
| OpenAF | oafp | [66](#66) | Filter the OpenAF&#x27;s oafp examples list by a specific word in the description |
| OpenAF | oafp | [67](#67) | List the OpenAF&#x27;s oafp examples by category, sub-category and description |
| Unix | Alpine | [68](#68) | List all installed packages in an Alpine system |
| Unix | Compute | [69](#69) | Parses the Linux /proc/cpuinfo into an array |
| Unix | Debian/Ubuntu | [70](#70) | List all installed packages in a Debian/Ubuntu system |
| Unix | Files | [71](#71) | Converting the Linux&#x27;s /etc/os-release to SQL insert statements. |
| Unix | Files | [72](#72) | Converting the Unix&#x27;s syslog into a json output. |
| Unix | Files | [73](#73) | Parses the Linux /etc/passwd to a table order by uid and gid. |
| Unix | Generic | [74](#74) | Creates, in unix, a data.ndjson file where each record is formatted from json files in /some/data |
| Unix | Network | [75](#75) | Loop over the current Linux active network connections |
| Unix | Network | [76](#76) | Parse the Linux &#x27;arp&#x27; command output |
| Unix | Network | [77](#77) | Parse the Linux &#x27;ip tcp_metrics&#x27; command |
| Unix | Network | [78](#78) | Parse the result of the Linux route command |
| Unix | OpenSuse | [79](#79) | List all installed packages in an OpenSuse system or zypper based system |
| Unix | RedHat | [80](#80) | List all installed packages in a RedHat system or rpm based system (use rpm --querytags to list all fields available) |
| Unix | Storage | [81](#81) | Converting the Unix&#x27;s df output |
| Unix | Storage | [82](#82) | Parses the result of the Unix ls command |
| Unix | SystemCtl | [83](#83) | Converting the Unix&#x27;s systemctl list-timers |
| Unix | SystemCtl | [84](#84) | Converting the Unix&#x27;s systemctl list-units |
| Unix | SystemCtl | [85](#85) | Converting the Unix&#x27;s systemctl list-units into an overview table |
| Unix | UBI | [86](#86) | List all installed packages in an UBI system |
| Windows | Network | [87](#87) | Output a table with the current route table using Windows&#x27; PowerShell |
| Windows | Network | [88](#88) | Output a table with the list of network interfaces using Windows&#x27; PowerShell |
| Windows | PnP | [89](#89) | Output a table with USB/PnP devices using Windows&#x27; PowerShell |
| Windows | Storage | [90](#90) | Output a table with the attached disk information using Windows&#x27; PowerShell |
