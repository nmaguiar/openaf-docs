...
| JSON Schemas | Lists | [48](#48) | Get a list of JSON schemas from Schema Store catalog |
| Kubernetes | Containers | [49](#49) | Parse the Linux cgroup cpu stats on a container running in Kubernetes |
| Kubernetes | Kubectl | [50](#50) | Build an output table with Kubernetes pods with namespace, pod name, container name and corresponding resources using kubectl |
| Kubernetes | Kubectl | [51](#51) | Build an output table with Kubernetes pods with node, namespace, pod name, container name and corresponding resources using kubectl |
| Kubernetes | Kubectl | [52](#52) | List of Kubernetes CPU, memory and storage stats per node using kubectl |
| Kubernetes | Kubectl | [53](#53) | List of Kubernetes pods per namespace and kind using kubectl |
| Mac | Brew | [54](#54) | List all the packages and corresponding versions installed in a Mac by brew. |
| Mac | Info | [55](#55) | Parses the current Mac OS overview information |
| Mac | Safari | [56](#56) | Get a list of all Mac OS Safari bookmarks into a CSV file. |
| OpenAF | Channels | [57](#57) | Copy the json result of a command into an etcd database using OpenAF&#x27;s channels |
| OpenAF | Channels | [58](#58) | Getting all data stored in an etcd database using OpenAF&#x27;s channels |
| OpenAF | Channels | [59](#59) | Perform a query to a metric &amp; label, with a start and end time, to a Prometheus server using OpenAF&#x27;s channels |
| OpenAF | Channels | [60](#60) | Retrieve all keys stores in a H2 MVStore file using OpenAF&#x27;s channels |
| OpenAF | Channels | [61](#61) | Store and retrieve data from a Redis database |
| OpenAF | Channels | [62](#62) | Store and retrieve data from a RocksDB database |
| OpenAF | Channels | [63](#63) | Store the json results of a command into a H2 MVStore file using OpenAF&#x27;s channels |
| OpenAF | Network | [64](#64) | List all network addresses returned from the current DNS server for a hostname using OpenAF |
| OpenAF | OS | [65](#65) | Current OS information visible to OpenAF |
| OpenAF | TLS | [66](#66) | List the TLS certificates of a target host with a sorted alternative names using OpenAF |
| OpenAF | oPacks | [67](#67) | Listing all currently accessible OpenAF&#x27;s oPacks |
| OpenAF | oafp | [68](#68) | Filter the OpenAF&#x27;s oafp examples list by a specific word in the description |
| OpenAF | oafp | [69](#69) | List the OpenAF&#x27;s oafp examples by category, sub-category and description |
| Unix | Alpine | [70](#70) | List all installed packages in an Alpine system |
| Unix | Compute | [71](#71) | Parses the Linux /proc/cpuinfo into an array |
| Unix | Debian/Ubuntu | [72](#72) | List all installed packages in a Debian/Ubuntu system |
| Unix | Files | [73](#73) | Converting the Linux&#x27;s /etc/os-release to SQL insert statements. |
| Unix | Files | [74](#74) | Converting the Unix&#x27;s syslog into a json output. |
| Unix | Files | [75](#75) | Parses the Linux /etc/passwd to a table order by uid and gid. |
| Unix | Generic | [76](#76) | Creates, in unix, a data.ndjson file where each record is formatted from json files in /some/data |
| Unix | Network | [77](#77) | Loop over the current Linux active network connections |
| Unix | Network | [78](#78) | Parse the Linux &#x27;arp&#x27; command output |
| Unix | Network | [79](#79) | Parse the Linux &#x27;ip tcp_metrics&#x27; command |
| Unix | Network | [80](#80) | Parse the result of the Linux route command |
| Unix | OpenSuse | [81](#81) | List all installed packages in an OpenSuse system or zypper based system |
| Unix | RedHat | [82](#82) | List all installed packages in a RedHat system or rpm based system (use rpm --querytags to list all fields available) |
| Unix | Storage | [83](#83) | Converting the Unix&#x27;s df output |
| Unix | Storage | [84](#84) | Parses the result of the Unix ls command |
| Unix | SystemCtl | [85](#85) | Converting the Unix&#x27;s systemctl list-timers |
| Unix | SystemCtl | [86](#86) | Converting the Unix&#x27;s systemctl list-units |
| Unix | SystemCtl | [87](#87) | Converting the Unix&#x27;s systemctl list-units into an overview table |
| Unix | UBI | [88](#88) | List all installed packages in an UBI system |
| Windows | Network | [89](#89) | Output a table with the current route table using Windows&#x27; PowerShell |
| Windows | Network | [90](#90) | Output a table with the list of network interfaces using Windows&#x27; PowerShell |
| Windows | PnP | [91](#91) | Output a table with USB/PnP devices using Windows&#x27; PowerShell |
| Windows | Storage | [92](#92) | Output a table with the attached disk information using Windows&#x27; PowerShell |
